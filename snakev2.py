...
# Pantalla de inicio (solo una vez)
pantalla_inicio()
...
while True:
  ...
  if serpiente[0][0] < 0 or serpiente[0][0] >= 480 or serpiente[0][1] < 40 or serpiente[0][1] >= 400 or serpiente[0] in serpiente[1:]:
